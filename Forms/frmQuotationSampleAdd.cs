...
{
    public partial class frmQuotationSampleAdd : Form
    {
        public int addIndex=0;
        public int curIndex=0;
        public string insertType = "";
        public frmQuotationSampleAdd(int index)
        {
            InitializeComponent();
        ...
        private void frmQuotationSampleAdd_FormClosed(object sender, FormClosedEventArgs e)
        {
