...
{
    public partial class frmMmStdPriceClass : Form
    {
        ...
        {
            string strSql = " Select clr_grp From mm_stdprice_class Where prd_item='" + txtPrd_type.Text + "' And clr_grp='" + lueClr_Grp.EditValue.ToString() + "' And size_id='" + txtSize_Id.Text + "'";
        ...
        private void Save()
        {
            ...
            string strSql = "";
            string result = "";
            string prd_mat = txtPrd_mat.Text;
            string art = txtArt.Text;
            string prd_type = txtPrd_type.Text;
            ...
            if (txtId.Text.Trim() == "")//新增
                strSql = string.Format(@"INSERT INTO mm_stdprice_class (prd_item,prd_cdesc,clr_grp,size_id,unit,ex_fty,fob,vat,crusr,crtim)
                    ...
                    , prd_type, prd_cdesc, clr_grp, size_id, unit, ex_fty, fob, vat, userid);
            else
                strSql = string.Format(@"UPDATE mm_stdprice_class SET unit='{0}',ex_fty='{1}',fob='{2}',vat='{3}',crusr='{4}',crtim=GETDATE()
                    ...
                    , unit, ex_fty, fob, vat, userid, prd_type, clr_grp, size_id);
        ...
        private void loadData()
        {
            ...
            strSql = "Select a.*,c.cdesc AS color_group_cdesc,b.size_cdesc" +
                ...
                " Where a.prd_item>=''";
            if (txtPrd_type.Text != "")
                strSql += " And a.prd_item='" + txtPrd_type.Text + "'";
            if (clr_grp != "")
        ...
        private void fillTextBox(int rows)
        {
            ...
            txtPrd_type.Text = CurrentRow.Cells["colPrd_item"].Value.ToString();
        ...
        {
            txtPrd_type.Properties.ReadOnly = !append_mode;
            ...
            {
                txtPrd_type.BackColor = Color.White;
                lueClr_Grp.BackColor = Color.White;
                txtSize_Id.BackColor = Color.White;
            }
            else
            {
                txtPrd_type.BackColor = Color.Silver;
        ...
        private void Delete()
        {
            ...
            strSql = string.Format(@"DELETE mm_stdprice_class WHERE prd_item='{0}' And clr_grp='{1}' And size_id='{2}'", txtPrd_type.Text, clr_grp, txtSize_Id.Text);
            result = clsPublicOfCF01.ExecuteSqlUpdate(strSql);
