...
namespace cf01.Forms
{
	public partial class frmDeliveryBill : Form
	{
		...
		private void Edit()  //編輯
		{
            ...
            lkeM_id.BackColor = System.Drawing.Color.White;
            lkeSate.Enabled = false;
            lkeSate.BackColor = System.Drawing.Color.White;
        ...
        private void frmDeliveryBill_FormClosed(object sender, FormClosedEventArgs e)
        {
            System.GC.Collect();
        }
        ...
        {            
            ...
            {                
                ...
                if (dt.Rows.Count > 0)
                {
                    strGenNo = string.Format("{0}-{1}", strSales_Group, (int.Parse(dt.Rows[0]["bill_code"].ToString()) + 1).ToString("00000000"));//strSales_Group + "-" + (int.Parse(dt.Rows[0]["bill_code"].ToString())+1).ToString("00000000");
        ...
        {
            decimal total_amount, cur_row_amount, disc_rate, disc_amt, disc_spare_amount;
            decimal goods_amount = 0;
            decimal fare_amount = 0;
        ...
        private void insertToGeo()
        {
            if (dgvIdDetails.RowCount == 0)
                return;
            if (!clsDeliveryBill.Check_Add_Popedom("frmDeliveryBill"))
            {
