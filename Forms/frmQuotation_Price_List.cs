...
namespace cf01.Forms
{
    public partial class frmQuotation_Price_List : Form
    {
        ...
        public frmQuotation_Price_List(string temp_code,bool is_display_remark_pdd)
        {
            ...
            @"SELECT temp_code,ver,number_enter,price_usd,price_hkd,price_rmb,price_unit,hkd_ex_fty,usd_ex_fty,discount,disc_price_usd,
            disc_price_hkd,disc_price_rmb,disc_hkd_ex_fty,rmb_remark,remark_pdd,remark,date,crtim,amusr,amtim,ref_temp_code
