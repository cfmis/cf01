...
{
    public partial class frmOut_Process_S2 : Form
    {
        ...
        public frmOut_Process_S2()
        {
            InitializeComponent();
        }

        private void frmOut_Process_S2_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            dtPlate = clsPublicOfCF01.ExecuteProcedureReturnTable("p_rpt_out_process_out_vendor", paras);
            //--
        ...
        private void frmOut_Process_S2_FormClosed(object sender, FormClosedEventArgs e)
        {
            clsConErp = null;
            dtPlate = null;
            dtMo_Data = null;
        ...
        {
            cboVendor_id2.Focus();
            if (cboVendor_id1.Text == "" || cboVendor_id2.Text == "")
            {
                MessageBox.Show("供應商編號不可以空!", "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cboVendor_id1.Focus();
                return;
            }
