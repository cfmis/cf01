...
{
    public partial class xrPurCashFlow: DevExpress.XtraReports.UI.XtraReport
    {
        string m_date_from, m_date_to;
        public xrPurCashFlow(string p_date_from, string p_date_to)
        {
            InitializeComponent();
        ...
        private void xrPurCashFlow_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //分組            
