...
{
    public partial class xrPrdTransfer_dm : DevExpress.XtraReports.UI.XtraReport
    {
        private DataTable dtPOInfo = new DataTable();
        private DataTable dtPartsInfo = new DataTable();

        public xrPrdTransfer_dm(DataTable dtMain, DataTable dtParts)
        {
            InitializeComponent();
            dtPOInfo = dtMain;
            dtPartsInfo = dtParts;
