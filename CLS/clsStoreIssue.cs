...
namespace cf01.CLS
{
    class clsStoreIssue
    {
        ...
        //從生產計劃中獲取倉庫發料的記錄
        public DataTable GetFlRecFromJo(string loc, string mo_id,string seq, string mat_id)
        {
            DataTable dtFlRec = new DataTable();
        ...
        //產生新的發料單號
        public string AddNewDoc(storeissue objModel)
        {
            int result = 0;
            string strSql = "";
            string strSql_f = "";
        ...
        //檢查單據是否有不同的倉庫號
        public DataTable checkDocDiffLoc(string id,string mo_id,string goods_id)
        {
            DataTable dtId = new DataTable();
        ...
        //插入發貨記錄到明細表
        public string AddStoreRec(List<storeissue> listDetail)
        {
            int result = 0;
            string strSql = "";
