...
namespace cf01.CLS
{
    public class clsShowProductionPlan
    {
        ...
        public DataTable GetProductionPlanMostly(string pMo_id)
        {
            ...
            try
            {
                ...
                dtPlanMostly = clsConErp.GetDataTable(strSql);
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        public DataTable GetProductionPlanDetails(string pId)
        {
        ...
        /// <returns></returns>
        public string GetImagePath(string pGoods_id)
        {
            string strImagePath = "";
            ...
            try
            {
                ...
                WHERE a.within_code='0000' and a.id='{0}' AND Isnull(b.picture_name,'')<>''
                ORDER BY b.sequence_id", pGoods_id);
