...
namespace cf01.CLS
{
    class clsInsertPictureToExcel
    {
        ...
        public void Open(string TemplateFilePath)
        {
            ...
            //Range rngRow = (Excel.Range)m_objSheet.Columns[1, Type.Missing];
            //m_objSheet.Rows.Height = 70;
            


        }
        public string GetExcelVer()
        {
            return m_objExcel.Version;
        }
        public void SetRowHeight(int heightNo,int colNo,int WidthNo)
        {
            Range rngRow = (Excel.Range)m_objSheet.Columns[colNo, Type.Missing];
            rngRow.RowHeight = heightNo;
            rngRow.ColumnWidth = WidthNo;
        }
