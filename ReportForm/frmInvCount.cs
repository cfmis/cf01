...
{
    public partial class frmInvCount : Form
    {
        ...
        private void frmInvCount_Load(object sender, EventArgs e)
        {
        ...
        private void frmInvCount_FormClosed(object sender, FormClosedEventArgs e)
        {
            dtReport.Dispose();           
        }
        ...
        { 
            if (txtDat1.Text == "" && txtDat2.Text == "" &&txtSalesGroup.Text ==""&&txtInv1.Text ==""&&txtInv2.Text=="" )
            {
            ...
            SqlParameter[] paras = new SqlParameter[]{
                ...
                new SqlParameter("@inv_no_s",txtInv1.Text),
                new SqlParameter("@inv_no_e",txtInv2.Text)
            };            
            dtReport = clsPublicOfCF01.ExecuteProcedureReturnTable("usp_rpt_inv_details", paras);           
        ...
        private void BTNEXCEL_Click(object sender, EventArgs e)
        {
            ...
            oxls.ExportToExcel_Fast(dgvDetails);
        }
        ...
        private void txtInv1_Leave(object sender, EventArgs e)
        {
            txtInv2.Text = txtInv1.Text;
        }
    }
}
