...
{
    public partial class frmOcCount : Form
    {
        ...
        private void frmOcCount_Load(object sender, EventArgs e)
        {
        ...
        private void frmOcCount_FormClosed(object sender, FormClosedEventArgs e)
        {
            dtReport.Dispose();           
        }
        ...
        { 
            ...
            dtReport = clsPublicOfCF01.ExecuteProcedureReturnTable("usp_rpt_oc_data_v", paras);           
