    ...
    class PrintDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                cf01.ModuleForm.PrintOptions dlg = new PrintOptions(AvailableColumns);
        ...
        public static void Print_DataGridView(DataGridView dgv1,string strPrintTile)
        {
            PrintPreviewDialog ppvw;
            try
            {
                ...
                PrintTitle = dlg.PrintTitle + strPrintTile;//傳進來的列印表頭
                PrintAllRows = dlg.PrintAllRows;
                FitToPageWidth = dlg.FitToPageWidth;
                SelectedColumns = dlg.GetSelectedColumns();
                ...
                ppvw = new PrintPreviewDialog();
                ppvw.PrintPreviewControl.Zoom = 1.0; //默認預監頁面為100% ADD BY 2018-05-12
                (ppvw as Form).WindowState = FormWindowState.Maximized; //预览窗体加载时最大化
                ppvw.Document = printDoc;
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            //列印時間
                            String s = String.Format("{0} {1}", DateTime.Now.ToLongDateString(), DateTime.Now.ToShortTimeString());
